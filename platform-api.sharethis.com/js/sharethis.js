...
(function() {
    ...
    null == window.__sharethis__ && (window.__sharethis__ = {
        ...
        for (s = ["property", "name"], n = 0, o = s.length; n < o; n++)
            for (t = s[n], a = ["og:description", "twitter:description", "description", "Description"], r = 0, i = a.length; r < i; r++)
                if (l = a[r], e = document.querySelector("meta[" + t + "='" + l + "']")) return e.content;
        return ""
    }, e.getImage = function() {
        var e, t, n, r, o, i, s, a, l;
        for (s = ["property", "name"], n = 0, o = s.length; n < o; n++)
            for (t = s[n], a = ["og:image", "twitter:image"], r = 0, i = a.length; r < i; r++)
                if (l = a[r], e = document.querySelector("meta[" + t + "='" + l + "']")) return e.content;
        return ""
        ...
        var e, t, n, r, o, i, s, a, l;
        for (s = ["property", "name"], n = 0, o = s.length; n < o; n++)
            for (t = s[n], a = ["og:title", "twitter:title"], r = 0, i = a.length; r < i; r++)
                if (l = a[r], e = document.querySelector("meta[" + t + "='" + l + "']")) return e.content;
        ...
        if (o = document.referrer) {
            ...
            for (t = ["aol", "bing", "bs.to", "facebook", "google", "yahoo", "yandex", document.location.hostname], i = 0, s = t.length; i < s; i++)
...
"undefined" == typeof __stdos__.data && (__stdos__.data = {
        ...
        getEUConsent: function(t) {
            ...
            if (null !== s) __stdos__.data.setConsent({
                ...
                var a = document.createElement("iframe"),
                    n = "https://c.sharethis.mgr.consensu.org/portal-v2.html";
                a.setAttribute("src", n), a.setAttribute("id", "st_gdpr_iframe"), a.setAttribute("title", "GDPR Consent Management"), a.style.width = "0px", a.style.height = "0px", a.style.position = "absolute", a.style.left = "-5000px";
                ...
                __stdos__.data.bindEvent(window, "message", function(t) {
                    if ("https://c.sharethis.mgr.consensu.org" == t.origin) {
                        var e = t.data && t.data.command,
                            s = t.data,
                            n = t.data && t.data.supports_samesite;
                        "isLoaded" == e && a.contentWindow.postMessage({
                            command: "readAllCookies"
                        }, "*"), "readAllCookies" == e && (__stdos__.data.setConsent({
                            bsamesite: n,
                            consentData: s.v1,
                            consentDomain: ".consensu.org",
                            gdpr_consent: s.v2 || s.v1,
                            gdpr_consent_v1: s.v1,
        ...
        log: function(t, e, o) {
            __stdos__.data.set("ts" + (new Date).getTime(), "", "pageInfo"), e = __stdos__.logger.loggerUrl, __stdos__.data.getEUConsent(function(s) {
                var a = [e, t, "?event=" + t, "&" + __stdos__.logger.constructParamString(), "&version=" + __stdos__.logger.version, "&lang=" + __stdos__.logger.lang].join("");
                try {
                    var n = new XMLHttpRequest;
                    n.open("GET", a, !0), n.withCredentials = !0, n.onreadystatechange = function() {
    ...
    function() {
        ...
        "genesis-media" == t.product ? t.send("https://l.sharethis.com/gmedia", {
            url: t.href
        }) : e || __stdos__.onscriptload || document.URL.indexOf("edge.sharethis.com") != -1 || (__stdos__.data.init(), __stdos__.data.set("cms", t.cms, "pageInfo"), __stdos__.data.set("publisher", t.property, "pageInfo"), __stdos__.data.set("product", t.product, "pageInfo"), __stdos__.data.set("source", t.source, "pageInfo"), t.embeds && st.embeds.length > 0 && !t.is_ie && (__stdos__.data.set("embeds_csv", t.embeds.join(","), "pageInfo"), setTimeout(function() {
...
(function() {
    var o;
    o = window.__sharethis__, o.loader["gdpr-compliance-tool-v2"] = function(s) {
        var r, e, n, l, i, t, c, u, p, a;
        if (null == s && (s = {}), s.enabled) return e = s.background_color, n = s.color, l = s.display, i = s.gear_color, t = s.gear_position, c = s.publisher_name, u = s.publisher_purposes, p = s.scope, a = s.text_color, null == c && (c = ""), null == u && (u = []), window.__cmpconfig = {
            background_color: e,
            color: n,
            gear_color: i,
            gear_position: t,
            ...
            purposes: u,
            text_color: a
        }, "always" === l ? o.js("https://c.sharethis.mgr.consensu.org/cmp-v2.js") : "eu" === l ? (r = new XMLHttpRequest, r.open("GET", "https://c.sharethis.mgr.consensu.org/is_eu"), r.responseType = "json", r.onload = function(s) {
            return function() {
                var s;
                if (null != (s = r.response) ? s.is_eu : void 0) return o.js("https://c.sharethis.mgr.consensu.org/cmp-v2.js")
            }
        }(this), r.send()) : void 0
    }
}).call(this);
...
(function() {
    window.__sharethis__.md5 = "808f1de38370ab3289bf25ca1c0882fb";
})();