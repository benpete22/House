! function(e) {
    function r(r) {
        for (var n, i, a = r[0], c = r[1], f = r[2], p = 0, s = []; p < a.length; p++) o[i = a[p]] && s.push(o[i][0]), o[i] = 0;
            ...
            if (t) r.push(t[2]);
                ...
                a.charset = "utf-8", a.timeout = 120, i.nc && a.setAttribute("nonce", i.nc), a.src = function(e) {
                    return i.p + "" + ({}[e] || e) + "-es2015." + {
                        4: "5485ed030f03e0c5f6ca",
                        5: "00a27439b4f4e7398547",
                        6: "c2f454141df6ebfeb0dd",
                        7: "0ceec63005dccde345e7"
                    }[e] + ".js"
                }(e);
                var c = new Error;
                u = function(r) {
